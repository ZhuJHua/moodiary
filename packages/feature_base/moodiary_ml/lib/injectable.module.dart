...
import 'package:moodiary_ml/src/sentiment_engine.dart' as _i698;
import 'package:moodiary_ml/src/sentiment_models.dart' as _i200;
...
class MoodiaryMlPackageModule extends _i526.MicroPackageModule {
  ...
  _i687.FutureOr<void> init(_i526.GetItHelper gh) {
    ...
    gh.lazySingleton<_i200.SentimentModelManager>(
      () => _i200.SentimentModelManager(gh<_i765.IHttpClient>()),
    );
    ...
    gh.lazySingleton<_i698.SentimentEngine>(
      () => _i698.SentimentEngine(gh<_i200.SentimentModelManager>()),
    );
  }
}
