...
class AssistantTraces extends Table
    with TableInfo<AssistantTraces, AssistantTracesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  AssistantTracesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return AssistantTracesData(
      messageId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}message_id'],
      )!,
...
class AssistantTracesData extends DataClass
    implements Insertable<AssistantTracesData> {
  final String messageId;
  final String sessionId;
  final int promptVersion;
  final String turnsJson;
  final int createdAt;
  const AssistantTracesData({
    required this.messageId,
    required this.sessionId,
  ...
  factory AssistantTracesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  AssistantTracesData copyWithCompanion(AssistantTracesCompanion data) {
    return AssistantTracesData(
      messageId: data.messageId.present ? data.messageId.value : this.messageId,
      sessionId: data.sessionId.present ? data.sessionId.value : this.sessionId,
  ...
  @override
  String toString() {
    return (StringBuffer('AssistantTracesData(')
          ..write('messageId: $messageId, ')
          ..write('sessionId: $sessionId, ')
...
class AssistantTracesCompanion extends UpdateCompanion<AssistantTracesData> {
  final Value<String> messageId;
  final Value<String> sessionId;
  ...
  AssistantTracesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       turnsJson = Value(turnsJson),
       createdAt = Value(createdAt);
  static Insertable<AssistantTracesData> custom({
    Expression<String>? messageId,
    Expression<String>? sessionId,
