...
class DiaryFtsData extends DataClass implements Insertable<DiaryFtsData> {
  ...
  const DiaryFtsData({this.titleTok, this.bodyTok});
  @override
  ...
  factory DiaryFtsData.fromJson(
    ...
    return DiaryFtsData(
      titleTok: serializer.fromJson<String?>(json['titleTok']),
      bodyTok: serializer.fromJson<String?>(json['bodyTok']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'titleTok': serializer.toJson<String?>(titleTok),
      'bodyTok': serializer.toJson<String?>(bodyTok),
    };
  }
...
class ChatSessionsData extends DataClass
  ...
  factory ChatSessionsData.fromJson(
    ...
    return ChatSessionsData(
      ...
      agentPresetId: serializer.fromJson<String?>(json['agentPresetId']),
      personaSnapshot: serializer.fromJson<String?>(json['personaSnapshot']),
      toolsSnapshotJson: serializer.fromJson<String?>(
        json['toolsSnapshotJson'],
      ),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'agentPresetId': serializer.toJson<String?>(agentPresetId),
      'personaSnapshot': serializer.toJson<String?>(personaSnapshot),
      'toolsSnapshotJson': serializer.toJson<String?>(toolsSnapshotJson),
    };
  }
...
class AgentPresets extends Table
    with TableInfo<AgentPresets, AgentPresetsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  AgentPresetsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return AgentPresetsData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
...
class AgentPresetsData extends DataClass
    implements Insertable<AgentPresetsData> {
  final String id;
  final String name;
  ...
  factory AgentPresetsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  AgentPresetsData copyWithCompanion(AgentPresetsCompanion data) {
    return AgentPresetsData(
      id: data.id.present ? data.id.value : this.id,
      name: data.name.present ? data.name.value : this.name,
  ...
  @override
  String toString() {
    return (StringBuffer('AgentPresetsData(')
          ..write('id: $id, ')
          ..write('name: $name, ')
...
class AgentPresetsCompanion extends UpdateCompanion<AgentPresetsData> {
  final Value<String> id;
  final Value<String> name;
  ...
  AgentPresetsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       createdAt = Value(createdAt),
       updatedAt = Value(updatedAt);
  static Insertable<AgentPresetsData> custom({
    Expression<String>? id,
    Expression<String>? name,
