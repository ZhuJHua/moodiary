...
bool operator ==(Object other) {
  final _this = this as LlmModelPreset;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LlmModelPreset&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.name, _this.name) || other.name == _this.name)&&(identical(other.protocol, _this.protocol) || other.protocol == _this.protocol)&&(identical(other.baseUrl, _this.baseUrl) || other.baseUrl == _this.baseUrl)&&(identical(other.description, _this.description) || other.description == _this.description)&&(identical(other.toolCall, _this.toolCall) || other.toolCall == _this.toolCall)&&(identical(other.reasoning, _this.reasoning) || other.reasoning == _this.reasoning)&&(identical(other.structuredOutput, _this.structuredOutput) || other.structuredOutput == _this.structuredOutput)&&(identical(other.temperature, _this.temperature) || other.temperature == _this.temperature)&&const DeepCollectionEquality().equals(other.reasoningOptions, _this.reasoningOptions)&&(identical(other.interleavedField, _this.interleavedField) || other.interleavedField == _this.interleavedField)&&(identical(other.contextLimit, _this.contextLimit) || other.contextLimit == _this.contextLimit)&&(identical(other.inputLimit, _this.inputLimit) || other.inputLimit == _this.inputLimit)&&(identical(other.outputLimit, _this.outputLimit) || other.outputLimit == _this.outputLimit)&&const DeepCollectionEquality().equals(other.inputModalities, _this.inputModalities)&&(identical(other.inputCost, _this.inputCost) || other.inputCost == _this.inputCost)&&(identical(other.outputCost, _this.outputCost) || other.outputCost == _this.outputCost)&&(identical(other.reasoningCost, _this.reasoningCost) || other.reasoningCost == _this.reasoningCost)&&(identical(other.cacheReadCost, _this.cacheReadCost) || other.cacheReadCost == _this.cacheReadCost)&&(identical(other.cacheWriteCost, _this.cacheWriteCost) || other.cacheWriteCost == _this.cacheWriteCost)&&(identical(other.releaseDate, _this.releaseDate) || other.releaseDate == _this.releaseDate)&&(identical(other.status, _this.status) || other.status == _this.status));
}
...
int get hashCode {
  final _this = this as LlmModelPreset;
  return Object.hashAll([runtimeType,_this.id,_this.name,_this.protocol,_this.baseUrl,_this.description,_this.toolCall,_this.reasoning,_this.structuredOutput,_this.temperature,const DeepCollectionEquality().hash(_this.reasoningOptions),_this.interleavedField,_this.contextLimit,_this.inputLimit,_this.outputLimit,const DeepCollectionEquality().hash(_this.inputModalities),_this.inputCost,_this.outputCost,_this.reasoningCost,_this.cacheReadCost,_this.cacheWriteCost,_this.releaseDate,_this.status]);
}

@override
String toString() {
  final _this = this as LlmModelPreset;
  return 'LlmModelPreset(id: ${_this.id}, name: ${_this.name}, protocol: ${_this.protocol}, baseUrl: ${_this.baseUrl}, description: ${_this.description}, toolCall: ${_this.toolCall}, reasoning: ${_this.reasoning}, structuredOutput: ${_this.structuredOutput}, temperature: ${_this.temperature}, reasoningOptions: ${_this.reasoningOptions}, interleavedField: ${_this.interleavedField}, contextLimit: ${_this.contextLimit}, inputLimit: ${_this.inputLimit}, outputLimit: ${_this.outputLimit}, inputModalities: ${_this.inputModalities}, inputCost: ${_this.inputCost}, outputCost: ${_this.outputCost}, reasoningCost: ${_this.reasoningCost}, cacheReadCost: ${_this.cacheReadCost}, cacheWriteCost: ${_this.cacheWriteCost}, releaseDate: ${_this.releaseDate}, status: ${_this.status})';
}
