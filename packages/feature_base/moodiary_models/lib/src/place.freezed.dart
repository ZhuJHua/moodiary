...
int get hashCode {
  final _this = this as Place;
  return Object.hash(runtimeType,_this.id,_this.name,_this.latitude,_this.longitude,_this.icon,_this.lastModified);
}

@override
String toString() {
  final _this = this as Place;
  return 'Place(id: ${_this.id}, name: ${_this.name}, latitude: ${_this.latitude}, longitude: ${_this.longitude}, icon: ${_this.icon}, lastModified: ${_this.lastModified})';
}
...
@useResult
$Res call({
 String id, String name, double latitude, double longitude, String? icon,@UtcDateTimeConverter() DateTime lastModified
});
...
/// Create a copy of Place
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? latitude = null,Object? longitude = null,Object? icon = freezed,Object? lastModified = null,}) {
  return _then(Place(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  double latitude,  double longitude,  String? icon, @UtcDateTimeConverter()  DateTime lastModified)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Place() when $default != null:
return $default(_that.id,_that.name,_that.latitude,_that.longitude,_that.icon,_that.lastModified);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  double latitude,  double longitude,  String? icon, @UtcDateTimeConverter()  DateTime lastModified)  $default,) {final _that = this;
switch (_that) {
case _Place():
return $default(_that.id,_that.name,_that.latitude,_that.longitude,_that.icon,_that.lastModified);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  double latitude,  double longitude,  String? icon, @UtcDateTimeConverter()  DateTime lastModified)?  $default,) {final _that = this;
switch (_that) {
case _Place() when $default != null:
return $default(_that.id,_that.name,_that.latitude,_that.longitude,_that.icon,_that.lastModified);case _:
  return null;
...
class _Place extends Place {
  const _Place({required this.id, required this.name, required this.latitude, required this.longitude, this.icon, @UtcDateTimeConverter() required this.lastModified}): super._();
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,name,latitude,longitude,icon,lastModified);
}

@override
String toString() {
    return 'Place(id: $id, name: $name, latitude: $latitude, longitude: $longitude, icon: $icon, lastModified: $lastModified)';
}
...
/// Create a copy of Place
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? latitude = null,Object? longitude = null,Object? icon = freezed,Object? lastModified = null,}) {
  return _then(_Place(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,latitude: null == latitude ? _self.latitude : latitude // ignore: cast_nullable_to_non_nullable
