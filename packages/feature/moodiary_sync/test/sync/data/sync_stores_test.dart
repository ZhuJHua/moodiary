...
void main() {
  ...
  test('write creates parent dirs and read round-trips at <base>/<type>/<name>',
      () async {
  ...
  group('cleanUpReplaced', () {
    test('removes media dropped by the new diary, keeps retained ones', () async {
    ...
    test('removed video also drops its thumbnail', () async {
      ...
      expect(await media.exists('video', thumb), isFalse,
