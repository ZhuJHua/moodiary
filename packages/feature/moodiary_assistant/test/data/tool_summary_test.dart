...
void main() {
  ...
  group('工具卡片摘要', () {
    ...
    test('被用户跳过的调用报已跳过', () {
      final spec = AssistantToolRegistry.byId(AssistantTool.updateDiary.id)!;
      expect(
        spec.summaryOf(const {}, assistantToolSkippedResult('updateDiary')),
        l10n.assistant.toolSkipped,
      );
    });
