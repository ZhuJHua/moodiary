...
/// 列表/瀑布/日历视图主体、[ViewModeSheet]、[DiaryCategorySectionView] 等可复用主体，
/// 以及 [diaryRoutes]。首页壳与 sync 状态由 app 侧组合（本包不依赖 moodiary_sync）。
library;
...
export 'src/presentation/widget/diary_category_section.dart'
    show DiaryCategorySectionView;
