...
final FontSchema = IsarGeneratedSchema(
  schema: IsarSchema(
    name: 'Font',
    idName: 'id',
    embedded: false,
...
int serializeFont(IsarWriter writer, Font object) {
  IsarCore.writeString(writer, 1, object.fontFamily);
  IsarCore.writeString(writer, 2, object.fontType);
  IsarCore.writeString(writer, 3, object.fontFileName);
  IsarCore.writeString(writer, 4, isarJsonEncode(object.fontWghtAxisMap));
  return object.id;
}
...
Font deserializeFont(IsarReader reader) {
  ...
  _fontFileName = IsarCore.readString(reader, 3) ?? '';
...
class _FontUpdateImpl implements _FontUpdate {
  ...
  bool call({
    ...
    return collection.updateProperties(
          [id],
          {
            if (fontFamily != ignore) 1: fontFamily as String?,
            if (fontType != ignore) 2: fontType as String?,
            if (fontFileName != ignore) 3: fontFileName as String?,
          },
        ) >
        0;
  }
...
sealed class _FontQueryUpdate {
  int call({String? fontFamily, String? fontType, String? fontFileName});
}
