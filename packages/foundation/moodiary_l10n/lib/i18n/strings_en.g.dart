...
class _Translations$app$en extends Translations$app$zh {
	...
	@override String get dashStreak => 'Day streak';
	@override String get dashThisMonth => 'This month';
	@override String get dashAverageMood => 'Average mood';
...
class _Translations$diary$en extends Translations$diary$zh {
	...
	@override String get analyseTitle => 'Insights';
	@override String get analyseEmpty => 'No entries yet — go write one!';
	@override String get analyseTotal => 'Entries';
	@override String get analyseThisMonth => 'This month';
	@override String get analyseMoodAverage => 'Average mood';
	@override String get analyseStreak => 'Day streak';
	@override String get analyseLast6Months => 'Entries over the last 6 months';
	@override String analyseMonth({required Object month}) => '${month}';
