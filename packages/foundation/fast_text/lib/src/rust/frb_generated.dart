...
class HfTokenizerImpl extends RustOpaque implements HfTokenizer {
  ...
  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        FastTextLib.instance.api.rust_arc_increment_strong_count_HfTokenizer,
    rustArcDecrementStrongCount:
        FastTextLib.instance.api.rust_arc_decrement_strong_count_HfTokenizer,
    rustArcDecrementStrongCountPtr:
        FastTextLib.instance.api.rust_arc_decrement_strong_count_HfTokenizerPtr,
  );

  /// 含特殊 token（CLS/SEP 随 json 的 post-processor）。
  Future<Uint32List> encode({required String text}) => FastTextLib.instance.api
      .crateApiHfTokenizerHfTokenizerEncode(that: this, text: text);

  Future<List<Uint32List>> encodeBatch({required List<String> texts}) =>
      FastTextLib.instance.api.crateApiHfTokenizerHfTokenizerEncodeBatch(
        that: this,
        texts: texts,
      );

  Future<int?> tokenId({required String token}) => FastTextLib.instance.api
...
class TokenizerImpl extends RustOpaque implements Tokenizer {
  ...
  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        FastTextLib.instance.api.rust_arc_increment_strong_count_Tokenizer,
    rustArcDecrementStrongCount:
        FastTextLib.instance.api.rust_arc_decrement_strong_count_Tokenizer,
    rustArcDecrementStrongCountPtr:
        FastTextLib.instance.api.rust_arc_decrement_strong_count_TokenizerPtr,
  );
}
