...
class _SearchPosting extends SearchPosting {
  const _SearchPosting({@Id() required this.key, required  List<int> diaryIsarIds, required  List<int> termFreqs}): _diaryIsarIds = diaryIsarIds,_termFreqs = termFreqs,super._();
