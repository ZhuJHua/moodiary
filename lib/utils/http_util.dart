...
class HttpUtil {
  ...
  Future<Response<T>> get<T>(String path,
      {Map<String, dynamic>? parameters, ResponseType? type}) async {
    return await _dio.get<T>(path,
        queryParameters: parameters, options: Options(responseType: type));
  }

  Future<Response<T>> post<T>(String path,
      {Map<String, dynamic>? header, data, Options? option}) async {
  ...
  Future<Stream<String>?> postStream(String path,
    ...
    Response<ResponseBody> response = await _dio.post(path,
