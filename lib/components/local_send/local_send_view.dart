  ...
  Widget build(BuildContext context) {
              ...
              ActionChip(
                onPressed: () async {
                  final res = await showTextInputDialog(
                    context: context,
                    title: context.l10n.lanTransferChangeScanPort,
                    message: context.l10n.lanTransferChangePortDes,
                    textFields: [
                      DialogTextField(
                        hintText: context.l10n.scanPort,
                        ...
                        validator: (value) {
                          if (value != null) {
                            ...
                            return context.l10n.lanTransferChangePortError1;
                          }
                          return context.l10n.lanTransferChangePortError2;
                        },
                      ),
                    ],
                  );
                ...
                label: Obx(() {
                  return Text(
                    '${context.l10n.scanPort}: ${state.scanPort.value}',
                  );
                }),
              ),
              ActionChip(
                onPressed: () async {
                  final res = await showTextInputDialog(
                    context: context,
                    title: context.l10n.lanTransferChangeTransferPort,
                    message: context.l10n.lanTransferChangePortDes,
                    textFields: [
                      DialogTextField(
                        hintText: context.l10n.transferPort,
                ...
                label: Obx(() {
                  return Text(
                    '${context.l10n.transferPort}: ${state.transferPort.value}',
                  );
                }),
              ),
            ],
                ...
                return SegmentedButton<String>(
                  segments: [
                    ButtonSegment(
                      ...
                      label: Text(context.l10n.lanTransferSend),
                    ),
                    ButtonSegment(
                      value: 'receive',
                      icon: const Icon(Icons.move_to_inbox_rounded),
                      label: Text(context.l10n.lanTransferReceive),
                    ),
                  ],
    ...
    return isDashboard
        ...
        : ExpansionTile(
          ...
          title: Text(context.l10n.backupSyncLANTransfer),
